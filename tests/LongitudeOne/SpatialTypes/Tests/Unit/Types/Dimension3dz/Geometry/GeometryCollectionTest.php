 ...
 * @covers \LongitudeOne\SpatialTypes\Types\Dimension3z\Geometry\GeometryCollection
 */
class GeometryCollectionTest extends TestCase
{
    ...
    public function testAddElementWithGeometryCollection(): void
    {
        ...
        static::expectExceptionMessageIsOrContains('An instance of LongitudeOne\SpatialTypes\Types\Dimension3z\Geometry\GeometryCollection cannot contain another GeometryCollection nor GeographyCollection.');
    ...
    {
        $geometryCollection = new GeometryCollection();
        $element = new GeometricPoint2D(2, 0);
        ...
        $geometryCollection->addElement($element);
    }
    ...
    public function testToArray(): void
    {
        ...
        static::assertSame([[], [1, 2, 4326]], $geometryCollection->toArray());
    }
}
