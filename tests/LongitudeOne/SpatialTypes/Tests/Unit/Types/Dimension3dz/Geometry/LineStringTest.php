 ...
 * @covers \LongitudeOne\SpatialTypes\Types\Dimension3z\Geometry\LineString
 */
class LineStringTest extends TestCase
{
    ...
    public function testAddPoint(): void
    {
        ...
        $lineString->addPoint(new Point(1, 2, 3, 4327));
    }
    ...
    public function testConstructorWithGeodesicPoints(): void
    {
        ...
        static::assertFalse($lineString->isRing());
        static::assertTrue($lineString->isLine());
        static::assertEquals([[-40, -40, 0], [-45, 45, 1]], $lineString->toArray());
        ...
        static::assertTrue($lineString->isClosed());
        static::assertTrue($lineString->isRing());
        static::assertEquals([[-40, -40, 0], [-45, 45, 1], [-40, -40, 0]], $lineString->toArray());
    }
    ...
    {
        $lineString = new LineString([new Point(1, 2, 3), new Point(3, 4, 5)], 4326);
