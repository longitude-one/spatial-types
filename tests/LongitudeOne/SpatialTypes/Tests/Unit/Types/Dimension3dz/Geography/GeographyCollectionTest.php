...
use LongitudeOne\SpatialTypes\Types\Dimension3z\Geography\Point as Point3d;
use LongitudeOne\SpatialTypes\Types\Dimension3z\Geography\Polygon as GeographicPolygon;
use LongitudeOne\SpatialTypes\Types\Dimension3z\Geometry\Polygon as GeometricPolygon;
 ...
 * @covers \LongitudeOne\SpatialTypes\Types\Dimension3z\Geography\GeographyCollection
 */
class GeographyCollectionTest extends TestCase
{
    ...
    public function testAddElementWithGeographyCollection(): void
    {
        ...
        static::expectExceptionMessageIsOrContains('An instance of LongitudeOne\SpatialTypes\Types\Dimension3z\Geography\GeographyCollection cannot contain another GeometryCollection nor GeographyCollection.');
    ...
    public function testAddElementWithInvalidDimension(): void
    {
        ...
        $geographyCollection->addElement($point);
    }
    ...
    public function testToArray(): void
    {
        ...
        $geographyCollection->addElement($polygon);
        static::assertSame([[]], $geographyCollection->toArray());
        $geographyCollection->addElement(new Point3d(1, 2, 3, 4326));
        static::assertSame([[], [1, 2, 3]], $geographyCollection->toArray());
    }
}
