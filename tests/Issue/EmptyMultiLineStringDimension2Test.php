...
use LongitudeOne\SpatialTypes\Types\Dimension2\Geography\MultiLineString as GeographicMultiLineString;
...
/**
 * Issue #9: empty line-string members in Dimension2.
 *
 * @internal
 *
 * @coversNothing
 */
class EmptyMultiLineStringDimension2Test extends TestCase
{
    /** Coordinate arrays create empty members in the receiving context. */
    public function testGeographyCoordinateArrays(): void
    {
        $mixed = new GeographicMultiLineString([[], [[1, 2], [3, 4]], [], [[5, 6], [7, 8]], []], 4326);
        $single = new GeographicMultiLineString([[]], 4326);

        static::assertSame([[], [[1, 2], [3, 4]], [], [[5, 6], [7, 8]], []], $mixed->toArray());
        ...
        static::assertFalse($mixed->getLineString(0)->hasZ());
        static::assertFalse($mixed->getLineString(0)->hasM());
    ...
    {
        $original = new GeographicMultiLineString([[], [[1, 2], [3, 4]], []], 4326);
        $emptied = $original->withLineString(1, []);
        $filled = $original->withLineString(-1, [[1, 2], [3, 4]]);

        static::assertSame([[], [], []], $emptied->toArray());
        static::assertSame([[], [[1, 2], [3, 4]], [[1, 2], [3, 4]]], $filled->toArray());
        ...
        static::assertFalse($emptied->getLineString(1)->hasZ());
        static::assertFalse($emptied->getLineString(1)->hasM());
    }
    ...
    public function testGeographyObjectMembers(): void
    {
        ...
        $line = new GeographicLineString([[1, 2], [3, 4]], 4326);
        $otherLine = new GeographicLineString([[5, 6], [7, 8]], 4326);
        ...
        static::assertFalse($empty->hasZ());
        static::assertFalse($empty->hasM());
    ...
    public function testGeographyReferenceCopies(): void
    {
        ...
        static::assertSame([[], [[1, 2], [3, 4]], []], $referenced->toArray());
        static::assertSame([[], [[1, 2], [3, 4]], []], $renumbered->toArray());
        static::assertSame([[], [[1, 2], [3, 4]], []], $original->toArray());
        ...
        static::assertFalse($referenced->getLineString(0)->hasZ());
        static::assertFalse($renumbered->getLineString(2)->hasM());
    }

    /** Coordinate arrays create empty members in the receiving context. */
    public function testGeometryCoordinateArrays(): void
    {
        $mixed = new MultiLineString([[], [[1, 2], [3, 4]], [], [[5, 6], [7, 8]], []], 4326);
    ...
    {
        $original = new MultiLineString([[], [[1, 2], [3, 4]], []], 4326);
        $emptied = $original->withLineString(1, []);
        $filled = $original->withLineString(-1, [[1, 2], [3, 4]]);
    ...
    public function testGeometryObjectMembers(): void
    {
        ...
        $line = new LineString([[1, 2], [3, 4]], 4326);
        $otherLine = new LineString([[5, 6], [7, 8]], 4326);
