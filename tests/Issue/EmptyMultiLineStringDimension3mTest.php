...
/**
 * Issue #9: empty line-string members in Dimension3m.
 *
 * @internal
 *
 * @coversNothing
 */
class EmptyMultiLineStringDimension3mTest extends TestCase
{
    /** Coordinate arrays create empty members in the receiving context. */
    public function testGeographyCoordinateArrays(): void
    {
        $mixed = new GeographicMultiLineString([[], [[1, 2, 7], [3, 4, 8]], [], [[5, 6, 9], [7, 8, 10]], []], 4326);
        $single = new GeographicMultiLineString([[]], 4326);

        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], [], [[5, 6, 9], [7, 8, 10]], []], $mixed->toArray());
    ...
    {
        $original = new GeographicMultiLineString([[], [[1, 2, 7], [3, 4, 8]], []], 4326);
        $emptied = $original->withLineString(1, []);
        $filled = $original->withLineString(-1, [[1, 2, 7], [3, 4, 8]]);

        static::assertSame([[], [], []], $emptied->toArray());
        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], [[1, 2, 7], [3, 4, 8]]], $filled->toArray());
        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], []], $original->toArray());
    ...
    public function testGeographyObjectMembers(): void
    {
        ...
        $line = new GeographicLineString([[1, 2, 7], [3, 4, 8]], 4326);
        $otherLine = new GeographicLineString([[5, 6, 9], [7, 8, 10]], 4326);
    ...
    public function testGeographyReferenceCopies(): void
    {
        ...
        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], []], $referenced->toArray());
        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], []], $renumbered->toArray());
        static::assertSame([[], [[1, 2, 7], [3, 4, 8]], []], $original->toArray());
    ...
    {
        $mixed = new MultiLineString([[], [[1, 2, 7], [3, 4, 8]], [], [[5, 6, 9], [7, 8, 10]], []], 4326);
    ...
    {
        $original = new MultiLineString([[], [[1, 2, 7], [3, 4, 8]], []], 4326);
        $emptied = $original->withLineString(1, []);
        $filled = $original->withLineString(-1, [[1, 2, 7], [3, 4, 8]]);
    ...
    public function testGeometryObjectMembers(): void
    {
        ...
        $line = new LineString([[1, 2, 7], [3, 4, 8]], 4326);
        $otherLine = new LineString([[5, 6, 9], [7, 8, 10]], 4326);
