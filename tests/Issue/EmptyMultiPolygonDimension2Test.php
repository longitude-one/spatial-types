...
use LongitudeOne\SpatialTypes\Types\Dimension2\Geography\MultiPolygon as GeographicMultiPolygon;
...
/**
 * Issue #10: empty polygon members in Dimension2.
 *
 * @internal
 *
 * @coversNothing
 */
class EmptyMultiPolygonDimension2Test extends TestCase
{
    ...
    public function testGeographyCoordinateArrays(): void
    {
        ...
        $mixed = new GeographicMultiPolygon([[], [[[0, 0], [4, 0], [4, 3], [0, 0]]], [], [[[10, 0], [14, 0], [14, 3], [10, 0]]], []], 4326);
        ...
        static::assertSame([[], [[[0, 0], [4, 0], [4, 3], [0, 0]]], [], [[[10, 0], [14, 0], [14, 3], [10, 0]]], []], $mixed->toArray());
    }
    ...
    public function testGeometryCoordinateArrays(): void
    {
        ...
        $mixed = new MultiPolygon([[], [[[0, 0], [4, 0], [4, 3], [0, 0]]], [], [[[10, 0], [14, 0], [14, 3], [10, 0]]], []], 4326);
