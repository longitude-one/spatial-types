...
use LongitudeOne\SpatialTypes\Types\Dimension3z\Geography\MultiPolygon as GeographicMultiPolygon;
...
/**
 * Issue #10: empty polygon members in Dimension3z.
 *
 * @internal
 *
 * @coversNothing
 */
class EmptyMultiPolygonDimension3zTest extends TestCase
{
    ...
    public function testGeographyCoordinateArrays(): void
    {
        ...
        $mixed = new GeographicMultiPolygon([[], [[[0, 0, 1], [4, 0, 1], [4, 3, 1], [0, 0, 1]]], [], [[[10, 0, 1], [14, 0, 1], [14, 3, 1], [10, 0, 1]]], []], 4326);
        ...
        static::assertTrue($single->getPolygon(0)->hasZ());
        static::assertFalse($single->getPolygon(0)->hasM());
        ...
        static::assertSame([[], [[[0, 0, 1], [4, 0, 1], [4, 3, 1], [0, 0, 1]]], [], [[[10, 0, 1], [14, 0, 1], [14, 3, 1], [10, 0, 1]]], []], $mixed->toArray());
    }
    ...
    public function testGeometryCoordinateArrays(): void
    {
        ...
        $mixed = new MultiPolygon([[], [[[0, 0, 1], [4, 0, 1], [4, 3, 1], [0, 0, 1]]], [], [[[10, 0, 1], [14, 0, 1], [14, 3, 1], [10, 0, 1]]], []], 4326);
